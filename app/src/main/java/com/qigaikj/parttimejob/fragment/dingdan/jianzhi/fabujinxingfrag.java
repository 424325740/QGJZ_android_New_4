...
import com.qigaikj.parttimejob.activity.dingdan.fabu.FJinxingActivity;
...
public class fabujinxingfrag extends Fragment {
    Unbinder unbinder;
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fabujinxing, container, false);
...
/*    @OnClick(R.id.fabujinxing)
    public void onViewClicked() {
        ActivityUtils.startActivity(getActivity(), FJinxingActivity.class);
    }*/
    ...
    private void getFabuData() {
        ...
        RetrofitManager.getInstance().createReq(BlogService.class).getFabujianzhi(toekn, "2").enqueue(new Callback<FabuJianzhiBean>() {
            @Override
            public void onResponse(Call<FabuJianzhiBean> call, Response<FabuJianzhiBean> response) {
                ...
                fabuAllAtapter.setItemClickCallBack(new FabuBaomingAtapter.ItemClick() {
                    ...
                    public void onIemcilbck(String wid) {
                        Intent intent=new Intent(getActivity(),FJinxingActivity.class);
