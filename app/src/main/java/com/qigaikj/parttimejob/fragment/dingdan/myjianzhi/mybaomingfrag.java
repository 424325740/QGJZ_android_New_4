...
import com.qigaikj.parttimejob.activity.dingdan.myjianzhi.MyJianzhiActivity;
...
public class mybaomingfrag extends Fragment {
    Unbinder unbinder;
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.baoming, container, false);
    ...
    public void onViewClicked() {
        ActivityUtils.startActivity(getActivity(), MyJianzhiActivity.class);
    }
    ...
    public void getJianzhiData() {
        ...
        RetrofitManager.getInstance().createReq(BlogService.class).getMyjianzhi(token, "1").enqueue(new Callback<MyJianzhiBean>() {
            @Override
