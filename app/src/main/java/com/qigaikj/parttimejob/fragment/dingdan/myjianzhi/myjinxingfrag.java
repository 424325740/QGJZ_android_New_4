...
import com.qigaikj.parttimejob.activity.dingdan.myjianzhi.MyJinxingActivity;
...
public class myjinxingfrag extends Fragment {
    Unbinder unbinder;
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.myjinxing, container, false);
    ...
    @OnClick(R.id.myjinxing)
    public void onViewClicked() {
        ActivityUtils.startActivity(getActivity(), MyJinxingActivity.class);
    }
    ...
    public void getJianzhiData() {
        ...
        RetrofitManager.getInstance().createReq(BlogService.class).getMyjianzhi(token, "2").enqueue(new Callback<MyJianzhiBean>() {
            @Override
