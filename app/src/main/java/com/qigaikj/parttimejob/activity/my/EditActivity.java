...
import com.qigaikj.parttimejob.bean.JsonBean;
import com.qigaikj.parttimejob.util.ActivityUtils;
import com.qigaikj.parttimejob.util.GetJsonDataUtil;
...
public class EditActivity extends BaseActivity {
    ...
    @OnClick({R.id.dataSelect, R.id.bianjibq, R.id.adders})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.dataSelect:
                ...
                break;
            case R.id.bianjibq:
                ActivityUtils.startActivity(EditActivity.this, LabelActivity.class);//跳转到标签编辑
                break;
            case R.id.adders:
//                ActivityUtils.startActivity(EditActivity.this, AddersActivity.class);
                showPickerView();
                break;
        }
    }
    private void initTimePicker() {//Dialog 模式下，在底部弹出
        ...
        pvTime = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {
                dataSelect.setText(getTime(date));
