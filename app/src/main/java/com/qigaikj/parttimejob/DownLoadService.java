...
import com.qigaikj.parttimejob.manager.fileload.FileCallback;
import com.qigaikj.parttimejob.manager.fileload.FileResponseBody;
...
public class DownLoadService extends Service {
     ...
     * 目标文件存储的文件名
     */
    private String destFileName = "qigaikeji.apk";
...
//    private Retrofit retrofit;
    ...
    private void loadFile(String url) {
        ...
        retrofit.baseUrl("http://qigaikj.com/")
