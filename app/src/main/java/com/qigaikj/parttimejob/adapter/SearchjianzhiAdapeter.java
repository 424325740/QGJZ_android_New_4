...
public class SearchjianzhiAdapeter extends BaseAdapter {
    private List<SearchJiluBean.DataBean> grideViewBeanList;
    private Context context;
    private LinearLayout checked;
    private String tname;

    public SearchjianzhiAdapeter(List<SearchJiluBean.DataBean> grideViewBeanList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text.setText(grideViewBeanList.get(position).getWork().get(position));
        return view;
    }
