...
public class DingdanjixingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    private List<List<DingDanYueTaBean.DataBean>> dingDanYueTaBeans;
    private Context context;
    private itemCablack itemCablack;

    public void setItemCablack(itemCablack itemCablack) {
        this.itemCablack = itemCablack;
    }

    public interface itemCablack{
        void onItemClick(int pos);
    }
    public DingdanjixingAdapter(List<List<DingDanYueTaBean.DataBean>> dingDanYueTaBeans, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.dingdanjinxingitem, null);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        myViewHolder.qx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                itemCablack.onItemClick(position);
            }
        });
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            qx = itemView.findViewById(R.id.llqx);
        }
    }
}
