...
public class SearchJianZhiDataAdapter extends RecyclerView.Adapter<SearchJianZhiDataAdapter.ViewHolder> {

    private String userSkill = "";
    public List<HomeSearchBean.DataBean> datas = null;
    ...
    public SearchJianZhiDataAdapter(Context context, List<HomeSearchBean.DataBean> datas) {
