...
public class TatyueAllAtapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<List<TaYuewoBean.DataBean>> lists;
    private Context context;

    public TatyueAllAtapter(List<List<TaYuewoBean.DataBean>> lists, Context context) {
        this.lists = lists;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.tayuealltiem, null);
