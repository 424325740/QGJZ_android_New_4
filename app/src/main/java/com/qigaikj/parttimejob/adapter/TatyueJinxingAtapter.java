...
public class TatyueJinxingAtapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<List<TaYuewoBean.DataBean>> lists;
    private Context context;

    public TatyueJinxingAtapter(List<List<TaYuewoBean.DataBean>> lists, Context context) {
        this.lists = lists;
