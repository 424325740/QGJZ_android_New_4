...
public class DingdanYiYaoqingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public DingdanYiYaoqingAdapter(List<List<DingDanYueTaBean.DataBean>> dingDanYueTaBeans, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.dingdanyaoqingitem, null);
