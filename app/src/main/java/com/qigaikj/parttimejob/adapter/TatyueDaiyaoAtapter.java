...
public class TatyueDaiyaoAtapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<List<TaYuewoBean.DataBean>> lists;
    private Context context;
    private Oncklickitem oncklickitem;

    public void setClickCallBack(Oncklickitem clickCallBack) {
        this.oncklickitem = clickCallBack;
    }

    public interface Oncklickitem{
        void ItemCaoblack(String did);
    }

    public TatyueDaiyaoAtapter(List<List<TaYuewoBean.DataBean>> lists, Context context) {
        this.lists = lists;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.tayuedaiyaotiem, null);
